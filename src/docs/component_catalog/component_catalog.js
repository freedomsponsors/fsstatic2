...
angular.module('component_catalog').factory('ComponentCatalogTreeModel', function(ComponentCatalog){
    var m = {
...
angular.module('component_catalog').directive('componentCatalogTree', function(ComponentCatalogTreeModel){
    return {
        restrict: 'E',
        scope: {
            group: '@'
        ...
        controller: function($scope) {
            var m = $scope.m = ComponentCatalogTreeModel;
            m.init($scope.group);
        }
    };
});
